...
local config = {
  ...
  colorscheme = "nightfox",  -- "catppuccin",
  ...
  plugins = {
    init = {
      ...
      -- telescope_tabs (telescope search for tabs)
      ...
      config[1] = {
        ...
        -- all of the children of this table will be treated together as a single component
        {
          ...
          astronvim.status.component.builder {
            ...
            surround = { separator = "right", color = { main = "blank_bg", left = "file_info_bg" } },
          },
        ...
        { -- make nav section with icon border
          ...
          astronvim.status.component.builder {
            ...
            surround = {
              separator = "right",
              color = function() return { main = astronvim.status.hl.mode_bg(), left = "blank_bg" } end,
            },
          },
          ...
          astronvim.status.component.nav {
            ...
            ruler = {
              ...
              hl = function() return { fg = "bg", bg = astronvim.status.hl.mode_bg() } end,
            },
            update = { "ModeChanged" },
            scrollbar = false,
        ...
        -- ✨ Right side decorator 🌈
        {
          astronvim.status.component.builder {
            ...
            surround = {
              ...
              color = function() return { left = astronvim.status.hl.mode_bg(), main = "d" } end,
            },
          },
          astronvim.status.component.builder {
            { provider = "" },
